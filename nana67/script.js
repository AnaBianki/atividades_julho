...
const palavrasEl = document.getElementById('palavra');
const letrasEl = document.getElementById('letras');
const tentativasEl = document.getElementById('tentativas-restantes'); // corrigido aqui
...
function iniciarJogo() {
    ...
    partes.forEach(parte => parte.style.display = 'none'); // esconde boneco no início

    atualizarTela();
}

function atualizarTela() {
    palavrasEl.textContent = palavraSecreta
        .split('')
    ...
    if (!palavrasEl.textContent.includes('_')) {
